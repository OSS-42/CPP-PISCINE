...
/*   Updated: 2023/05/15 08:45:10 by ewurstei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// -------- CANNON ----------
Form::Form(void) : m_name("Default"), m_signed(0), m_grade(150), m_execute(150) {
...
Form::Form(const Form& other) : m_name(other.m_name), m_signed(other.m_signed), m_grade(other.m_grade), m_execute(other.m_execute) {
	*this = other;
}
